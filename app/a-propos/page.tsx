  ...
  return (
    <main className="pt-28 pb-20 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-6 space-y-28 relative z-10">
        ...
        >
          <p
            className="text-[10px] tracking-[0.4em] uppercase font-body mb-6"
            style={{ color: '#fb923c' }}
          >
            Notre Histoire
          </p>
        ...
        <div>
          ...
          >
            <p
              className="text-[10px] tracking-[0.4em] uppercase font-body mb-3"
              style={{ color: '#fb923c' }}
            >
              Notre Philosophie
            </p>
            ...
            {values.map(({ icon, title, desc, color }, i) => (
              ...
              >
                ...
                >
                  ...
                  <h3
                    className="font-display font-light text-xl mb-3"
                    style={{ color }}
                  >
                    {title}
                  </h3>
            ...
            {team.map(({ name, role, origin, years }, i) => (
              ...
              >
                ...
                >
                  ...
                  <p
                    className="font-display font-light text-xl text-white mb-1"
                  >
                    {name}
                  </p>
                  <p
                    className="text-[10px] tracking-wider uppercase font-body mb-4"
                    style={{ color: '#fb923c' }}
                  >
                    {role}
                  </p>
