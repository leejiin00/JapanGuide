...
function ToriiSilhouette() {
  return (
    ...
    >
      ...
      {/* Kasagi curves (decorative top ends) */}
  ...
  return (
    <main>
      ...
      >
        ...
        {/* Glow orbs */}
        <FloatingOrb color="rgba(192,132,252,0.08)" style={{ width: 700, height: 700, top: '-15%', left: '-15%' }} />
        <FloatingOrb color="rgba(56,189,248,0.06)"  style={{ width: 500, height: 500, top: '10%',  right: '-10%' }} />
        <FloatingOrb color="rgba(251,146,60,0.06)"  style={{ width: 400, height: 400, bottom: '5%', left: '30%' }} />

        {/* Torii silhouette with parallax */}
        <motion.div
          style={{ y: springY }}
        ...
        >
          ...
          >
            Là où les ombres des pagodes dansent avec les néons. Là où le silence des jardins
            de pierre répond au fracas des métropoles infinies.
          </motion.p>
          ...
          >
            <motion.a
              href="#destinations"
              whileHover={{ scale: 1.05, boxShadow: '0 0 60px rgba(251,146,60,0.55), 0 0 120px rgba(251,146,60,0.2)' }}
              whileTap={{ scale: 0.97 }}
              className="px-9 py-4 rounded-full text-sm tracking-widest uppercase font-medium font-body"
              style={{
                background: 'linear-gradient(135deg, #fb923c, #f59e0b)',
                color: '#000',
                boxShadow: '0 0 35px rgba(251,146,60,0.35)',
              }}
            >
              Commencer le Voyage
            </motion.a>
            <motion.a
              href="/a-propos"
              whileHover={{ scale: 1.05, boxShadow: '0 0 30px rgba(255,255,255,0.08)', borderColor: 'rgba(255,255,255,0.3)' }}
              whileTap={{ scale: 0.97 }}
      ...
      >
        <div className="max-w-6xl mx-auto px-8 grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            ...
            >
              <p
                className="text-3xl font-display font-thin text-white mb-1"
              >
                {value}
                <span style={{ color: '#fb923c' }}>{suffix}</span>
              </p>
              <p
      ...
      <section id="destinations" className="relative py-32 px-6 overflow-hidden">
        <FloatingOrb color="rgba(139,92,246,0.1)"  style={{ width: 600, height: 600, top: '5%',   left: '-12%' }} />
        <FloatingOrb color="rgba(251,146,60,0.07)" style={{ width: 400, height: 400, bottom: '8%', right: '-8%' }} />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <p
              className="text-[10px] tracking-[0.4em] uppercase mb-5 font-body"
              style={{ color: '#fb923c' }}
            >
              地域 — Destinations
            </p>
      ...
      <section className="relative py-40 px-6 overflow-hidden">
        <div
          ...
          style={{
            background: `
              radial-gradient(ellipse 70% 70% at 50% 50%, rgba(251,146,60,0.07) 0%, transparent 65%),
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          >
            <motion.p
              className="text-6xl mb-10 block"
              animate={{ y: [0, -8, 0] }}
            ...
            >
              <div
                className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-px h-px w-48"
                style={{ background: 'linear-gradient(to right, transparent, rgba(251,146,60,0.6), transparent)' }}
                aria-hidden
              />
              <p
